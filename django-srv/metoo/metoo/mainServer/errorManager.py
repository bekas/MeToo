...
class ErrorManager:
	...
	ErrorMessage = {100: "Все ок!", 101: "Пользователя с таким логином не существует", 102: "Неверный пароль",103: "Ошибка при создании сессии", 110 : "Пожалуйста, авторизуйтесь!", 201 : "Пользователь с таким именем уже существует!", 202: "Ошибка при создании пользователя", 301 : "Ошибка при создании события", 302 : "Ошибка при выполнения запроса событий",303: "Такого события не существует", 501 : "Ошибка при подписке на событие",502 : "Пользователь не подписан на событие"}
